...
The landscape of language model applications has expanded significantly with various projects and tools aiming to enhance the interaction between humans and AI. In this section, we discuss related works that have influenced our project or share a common goal of improving language model capabilities.

\subsection{Maggie Appleton's Language Model Sketchbook}

Maggie Appleton's Language Model Sketchbook explores non-chatbot interfaces for language models, proposing alternative interaction paradigms such as "Daemons" and "Branches" to assist in writing and reasoning tasks[3][6]. These concepts emphasize the role of language models as "epistemic rubber ducks," serving as reflective thinking partners rather than mere conversational agents.

\subsection{DeepL Write}

DeepL Write is an AI-powered writing companion that assists users in refining their writing across various languages[4][7]. It offers suggestions for grammar and punctuation corrections, tone adjustments, and creative rephrasing, aiming to enhance clarity, precision, and expressiveness in written communication.
